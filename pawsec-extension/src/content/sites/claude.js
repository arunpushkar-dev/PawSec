/**
 * PawSec site adapter — Claude (claude.ai)
 * Intercepts: [data-testid="chat-input"] / .ProseMirror contenteditable div.
 *
 * Claude.ai is a SPA — the input is re-created on every new conversation.
 * The observer must stay alive; a guard prevents duplicate listener registration.
 */
...
// Keep observing — claude.ai SPA replaces the input on every new conversation
